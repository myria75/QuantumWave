...
class PythonParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PythonParser#quantum_gates_definition.
    def enterQuantum_gates_definition(self, ctx:PythonParser.Quantum_gates_definitionContext):
        pass

    # Exit a parse tree produced by PythonParser#quantum_gates_definition.
    def exitQuantum_gates_definition(self, ctx:PythonParser.Quantum_gates_definitionContext):
        pass
