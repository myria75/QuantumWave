...
class Python3ParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#quantum_gates_definition.
    def enterQuantum_gates_definition(self, ctx:Python3Parser.Quantum_gates_definitionContext):
        pass

    # Exit a parse tree produced by Python3Parser#quantum_gates_definition.
    def exitQuantum_gates_definition(self, ctx:Python3Parser.Quantum_gates_definitionContext):
        pass
