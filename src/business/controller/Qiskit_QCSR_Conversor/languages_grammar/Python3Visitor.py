...
if "." in __name__:
    from .Python3Parser import Python3Parser as PythonParser
    from .Python3ParserVisitor import Python3ParserVisitor as PythonParserVisitor
else:
    from Python3Parser import Python3Parser as PythonParser
    from Python3ParserVisitor import Python3ParserVisitor as PythonParserVisitor

class Python3Visitor(PythonParserVisitor):
